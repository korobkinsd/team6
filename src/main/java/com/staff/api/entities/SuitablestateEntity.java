...
@Entity
@Table(name = "suitablestate", schema = "team6", catalog = "")
public class SuitablestateEntity {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        SuitablestateEntity that = (SuitablestateEntity) o;
    ...
    @OneToMany(mappedBy = "suitablestateByIdSuitableState")
